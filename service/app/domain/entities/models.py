...
from app.domain.role.entities.role import Role, RoleMenu, RoleInheritance
...
from app.domain.rbac.entities.permission import Permission, RolePermission, Resource, DataScope
